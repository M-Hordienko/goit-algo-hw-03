...
users = [  # Список користувачів з їхніми датами народження
    ...
    {"name": "Jane Smith0", "birthday": "1990.03.05"},
    {"name": "Jane Smith1", "birthday": "1990.03.07"},
    {"name": "Jane Smith2", "birthday": "1990.03.10"},
    {"name": "Jane Smith3", "birthday": "1990.03.12"},
    {"name": "Jane Smith4", "birthday": "1990.03.14"},
]
...
prepared_users = preparing_users()
...
def find_upcoming_birthdays():
    ...
    return print(upcoming_birthdays)  # Виводимо список майбутніх днів народження
